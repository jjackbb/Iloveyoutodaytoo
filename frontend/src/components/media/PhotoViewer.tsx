 ...
 * 사진 한 장마다 한 칸씩 쌓인다.
 *
 * 확대는 세 가지 길로 열어둔다 — 손가락 두 개(핀치), 두 번 톡톡(더블탭), 그리고 [크게] 버튼.
 *
 * [크게] 버튼을 남겨둔 이유는 **한 손으로 볼 때**다. 핀치는 두 손이 필요하고,
 * 더블탭은 사진 넘기기와 헷갈린다. (그전 근거였던 "시니어라 보이는 버튼이 필수"는
 * 더 이상 쓰지 않는다 — 기준선은 _workspace/12_ux_baseline.md로 옮겼다)
 *
